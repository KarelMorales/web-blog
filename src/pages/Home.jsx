    ...
    <div className="pt-16">
      ...
      >
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full" style={{ opacity: 0.06 }}>
            ...
            <line x1="20%" y1="0" x2="120%" y2="100%" stroke="white" strokeWidth="0.8" />
            <line x1="-20%" y1="0" x2="80%"  y2="100%" stroke="white" strokeWidth="0.8" />
            <line x1="40%" y1="0" x2="140%" y2="100%" stroke="white" strokeWidth="0.5" />
            <line x1="-40%" y1="0" x2="60%"  y2="100%" stroke="white" strokeWidth="0.5" />
          </svg>

          {/* Large circle outlines — animated */}
          <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full border border-white" style={{ opacity: 0.08, animation: 'float-a 9s ease-in-out infinite' }} />
          <div className="absolute -top-4 -right-4 w-44 h-44 rounded-full border border-white" style={{ opacity: 0.07, animation: 'float-b 7s ease-in-out infinite' }} />
          <div className="absolute bottom-[10%] left-[10%] w-40 h-40 rounded-full border border-white" style={{ opacity: 0.07, animation: 'float-c 11s ease-in-out infinite' }} />
          <div className="absolute top-[40%] right-[5%] w-20 h-20 rounded-full border border-white" style={{ opacity: 0.1, animation: 'float-d 6s ease-in-out infinite' }} />

          {/* Plus / cross marks */}
          <div className="absolute top-[22%] left-[28%] w-5 h-5" style={{ opacity: 0.18 }}>
            <div className="absolute top-1/2 left-0 w-full h-px bg-white" />
            <div className="absolute left-1/2 top-0 h-full w-px bg-white" />
          </div>
          <div className="absolute top-[68%] left-[48%] w-6 h-6" style={{ opacity: 0.13 }}>
            <div className="absolute top-1/2 left-0 w-full h-px bg-white" />
            <div className="absolute left-1/2 top-0 h-full w-px bg-white" />
          </div>
          <div className="absolute bottom-[28%] right-[12%] w-4 h-4" style={{ opacity: 0.15 }}>
            <div className="absolute top-1/2 left-0 w-full h-px bg-white" />
            <div className="absolute left-1/2 top-0 h-full w-px bg-white" />
          </div>

          {/* Scattered squares / rects */}
          <div className="absolute top-[10%] left-[32%] w-4 h-4 border border-white" style={{ opacity: 0.18, transform: 'rotate(18deg)' }} />
          <div className="absolute top-[14%] left-[38%] w-2 h-2 bg-white" style={{ opacity: 0.2 }} />
          <div className="absolute top-[30%] left-[20%] w-6 h-6 border border-white" style={{ opacity: 0.12, transform: 'rotate(35deg)' }} />
          <div className="absolute top-[55%] left-[15%] w-3 h-3 bg-white" style={{ opacity: 0.12 }} />
          <div className="absolute top-[78%] left-[35%] w-5 h-5 border border-white" style={{ opacity: 0.13, transform: 'rotate(-22deg)' }} />
          <div className="absolute bottom-[15%] right-[22%] w-4 h-4 border border-white" style={{ opacity: 0.15, transform: 'rotate(45deg)' }} />
          <div className="absolute bottom-[10%] right-[10%] w-2 h-2 bg-white" style={{ opacity: 0.2 }} />
          <div className="absolute top-[48%] right-[6%] w-7 h-7 border border-white" style={{ opacity: 0.1, transform: 'rotate(12deg)' }} />
          <div className="absolute top-[8%] right-[18%] w-3 h-8 border border-white" style={{ opacity: 0.1 }} />

          {/* Thin horizontal rules */}
          <div className="absolute top-[28%] left-[18%] right-[4%] h-px bg-white" style={{ opacity: 0.07 }} />
          <div className="absolute bottom-[28%] left-[18%] right-[4%] h-px bg-white" style={{ opacity: 0.07 }} />

          {/* Diagonal left edge */}
          <div className="absolute inset-y-0 left-0 w-[3px] bg-white" style={{ opacity: 0.14 }} />
        ...
        <div aria-hidden="true">
          ...
          {/* Corner bracket top-right of text area */}
        ...
        {/* ── Hero content ── */}
        <div
          className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-10 flex items-center"
          style={{ minHeight: "calc(100vh - 64px)" }}
        >
      ...
      <section id="days" className="max-w-6xl mx-auto px-6 md:px-10 py-16">
        <div className="flex items-center gap-4 mb-10">
          ...
          <p className="text-[11px] text-muted whitespace-nowrap">7 entries</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-line border border-line">
          ...
          {/* Days 3-5 across 3 columns */}
          {rest.slice(2, 5).map((day) => (
            <DayCard key={day.slug} day={day} />
          ))}

          {/* Day 6 spans full width */}
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10 py-16 md:py-20">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-7">
              ...
              <p className="text-[15px] text-body leading-relaxed mb-4">
                Karel Morales is a graduating student from Zamboanga City—one of
                the oldest colonial settlements in the Philippines, founded in
                the same era as the walls of Intramuros she visited on Day 0.
              ...
              <p className="text-[15px] text-body leading-relaxed">
                ...
                never to be comprehensive—it was to be honest about what it felt
                like to move through these spaces as a final-year IT student
                seeing professional infrastructure at full scale for the first
                time.
              </p>
            </div>
